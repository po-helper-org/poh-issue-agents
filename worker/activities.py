...
# Блок кода в тройных обратных кавычках. Ревью, находка H2, случай 4: пример
# или шаблон для заполнения, процитированный в теле Issue тройными кавычками,
# не должен читаться как настоящий раздел сценария этой задачи.
