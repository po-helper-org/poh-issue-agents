...
# --- Под-задача шага (R5) ---
# Ставит MvpDelivery при заведении под-задачи шага плана (Task 9, активность
# mvp_open_substep). Такой Issue не поднимает свой жизненный цикл: он живёт
# время шага и закрывается вместе с ним — план родителя его уже разобрал, а
# триаж был бы разговором контура с самим собой. Вебхук проверяет метку раньше
# первого обращения к Temporal, тем же приёмом, что AGENTS_OFF проверяется
# раньше первого обращения к LLM.
STEP = "harness:step"
