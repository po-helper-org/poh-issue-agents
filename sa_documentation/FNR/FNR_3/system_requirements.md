...
| `MemberOut`/`ClusterOut`/`ClusterExtraction`/`MergeExtraction` | Схемы кластеризации | `worker/consolidation_activities.py:42-71` |
...
1. `temperature ≤ 0.2` при вызове (детерминизм таксономии) — M1.
